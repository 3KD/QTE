...
class QTEGUI(tk.Tk):
    ...
    def _build_tab_measure(self):
        ...
        ttk.Button(optrow, text="Show Register Marginals", command=self.on_show_marginals).pack(side="left", padx=6)
    ...
    def on_measure_state(self):
        try:
            ...
            ax.set_title(title)
            ax.set_xlabel("Basis"); ax.set_ylabel("Counts"); ax.legend(); fig.tight_layout()
